package com.peng.androidnewskill.page.slidingshut.baseactivity;
...
import com.peng.androidnewskill.base.actiivty.UtilBaseGesture;
 ...
 */
public class BaseSlidingShutFragmentActivity extends FragmentActivity {
    /**
     * 触摸工具类
     */
    ...
    private void setImmerseTitleBar() {
        ...
        View fillingView = rl_title.findViewById(R.id.view_filling);
        if (barHeight <= 0 || fillingView == null) {
            return;
        }

        if (rl_title instanceof RelativeLayout) {
            fillingView.setLayoutParams(
                    new RelativeLayout.LayoutParams(1, barHeight));
        }
    }
